...
- Filesystem (repo-local sources/outputs + user home state under `~/.omniagent/state/`) (011-instruction-file-sync)
...
## Recent Changes
- 011-instruction-file-sync: Added TypeScript 5.9 (ES2022) on Node.js 18+ + yargs, Node.js `fs/promises`, `path`, Vitest, Vite, Biome
