...
- Agent-scoped templating (`{selector-list ... }`) applies to all syncable features (skills,
  subagents, slash commands) and must be supported by future syncable features.
