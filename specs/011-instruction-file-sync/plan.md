...
**Branch**: `011-instruction-file-sync` | **Date**: 2026-01-17 | **Spec**: `specs/011-instruction-file-sync/spec.md`
**Input**: Feature specification from `/specs/011-instruction-file-sync/spec.md`
...
```text
specs/011-instruction-file-sync/
